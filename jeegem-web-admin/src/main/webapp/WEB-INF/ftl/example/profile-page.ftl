...
<html>
  <head>
    <title>JeeGem - Profile Page</title>
    ...
    <div id="wrap">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <!-- page header -->
          <@_pageHeader.pageHeader  '案例页面' '个人主页'/>
          <!-- /page header -->
                  ...
                  <div class="tile-widget color transparent-white rounded-top-corners">
                    ...
                    <div class="user-card">
                      ...
                      <ul class="profile-controls inline">
                        ...
                        <li class="avatar"><img src="${basePath}/resources/assets/images/profile-photo.jpg" alt="" class="img-circle profile-photo"></li>
                  ...
                  <div class="tile-body">
                    <ul class="friend-list">
                      ...
                      <li>
                        <div class="media">
                          <a class="pull-left profile-photo" href="#">
                            <img class="media-object img-circle" src="${basePath}/resources/assets/images/ici-avatar.jpg" alt="">
                          </a>
                      ...
                      <li>
                        <div class="media">                      
                          <a class="pull-left profile-photo" href="#">
                            <img class="media-object img-circle" src="${basePath}/resources/assets/images/arnold-avatar.jpg" alt="">
                          </a>
                          <div class="media-body">
                      ...
                      <li>
                        <div class="media">
                          <a class="pull-left profile-photo" href="#">
                            <img class="media-object img-circle" src="${basePath}/resources/assets/images/peter-avatar.jpg" alt="">
                          </a>
                          <div class="media-body">
                      ...
                      <li>
                        <div class="media">
                          <a class="pull-left profile-photo" href="#">
                            <img class="media-object img-circle" src="${basePath}/resources/assets/images/george-avatar.jpg" alt="">
                          </a>
                          <div class="media-body">
                      ...
                      <div class="feed-list">
                        ...
                        <article class="feed-post">
                          ...
                          <aside class="profile-photo">
                            <a href="#">
                              <img src="${basePath}/resources/assets/images/profile-photo.jpg" alt="" class="img-circle">
                            </a>
                          </aside>
                              ...
                              <ul class="comments">
                                ...
                                <li>
                                  <div class="profile-photo">
                                    <img src="${basePath}/resources/assets/images/peter-avatar.jpg" alt="" class="img-circle">
                                  </div>
                                ...
                                <li>
                                  <div class="profile-photo">
                                    <img src="${basePath}/resources/assets/images/ici-avatar.jpg" alt="" class="img-circle">
                                  </div>
                                ...
                                <li>
                                  <div class="profile-photo">
                                    <img src="${basePath}/resources/assets/images/arnold-avatar.jpg" alt="" class="img-circle">
                                  </div>
                        ...
                        <article class="feed-post">
                          ...
                          <aside class="profile-photo">
                            <a href="#">
                              <img src="${basePath}/resources/assets/images/george-avatar.jpg" alt="" class="img-circle">
                            </a>
                          </aside>
                          ...
                          <div class="feed-container">
                            ...
                            <div class="feed-content">
                              <div class="feed-image">
                                <img src="${basePath}/resources/assets/images/placeholder/img01.jpg" alt""="">
                              </div>
                              <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.</p>
                            </div>
