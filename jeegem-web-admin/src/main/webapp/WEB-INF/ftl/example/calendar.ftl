...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${basePath}/resources/assets/js/vendor/fullcalendar/fullcalendar.css">
  ...
  <body class="bg-1">
    ...
    <div id="wrap">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <!-- page header -->
          <@_pageHeader.pageHeader  '案例页面' '日历'/>
          <!-- /page header -->
    ...
    <script src="${basePath}/resources/assets/js/vendor/fullcalendar/lib/moment.min.js"></script>
    <script src="${basePath}/resources/assets/js/vendor/fullcalendar/old/jquery-ui-1.10.4.custom.min.js"></script>
    <script src="${basePath}/resources/assets/js/vendor/fullcalendar/fullcalendar.min.js"></script>
    <script src="${basePath}/resources/assets/js/vendor/touch-punch/jquery.ui.touch-punch.min.js"></script>

    <script src="${basePath}/resources/assets/js/vendor/colorpalette/bootstrap-colorpalette.js"></script>

    <script src="${basePath}/resources/assets/js/vendor/parsley/parsley.min.js"></script>
