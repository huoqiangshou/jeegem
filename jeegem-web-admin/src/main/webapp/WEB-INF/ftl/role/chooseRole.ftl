    ...
    <div id="wrap">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <!-- page header -->
          <@_pageHeader.pageHeader  '权限管理' '选择角色'/>
          <!-- /page header -->
		...
		<section class="tile color transparent-black" id="chooseRoleSection" >
                  <!-- tile header -->
                  ...
                  <div class="tile-body nopadding">
                    ...
                    <form class="form-horizontal" method="post" action="" id="formId" role="form">
                    <input type="hidden" id="userRoleId" value="${userRoleId}" />
                    <div class="col-sm-10">
						<button type="button" class="btn  btn-amethyst margin-bottom-20" id="saveRole">Save。。。</button>
                    </div>
                    ...
                    <table class="table" id="chooseRoleTable">
                        ...
                        <tr>
                          <td>
                              ...
                              <input type="checkbox" value="${it.id}" name="${it.name}" check='box' id="bchck${it.id}" <#if it.check> checked='checked'  </#if>>
                              <label for="bchck${it.id}"></label>
                            </div>
                          </td>
			...
			$(function(){
      		 		$("#saveRole").click(function(){
						...
						var index = layer.confirm("确定操作？",function(){
							...
							$.post('/role/addRole2User.shtml',{ids:ids.join(','),userId:$('#userRoleId').val()},function(result){
