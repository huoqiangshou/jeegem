...
<html>
  <head>
    ...
    <link rel="icon" type="image/ico" href="${basePath}/js/resources/assets/images/favicon.ico">
    <!-- Bootstrap -->
    <link href="${basePath}/js/resources/assets/css/vendor/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="${basePath}/js/resources/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" href="${basePath}/js/resources/assets/css/vendor/bootstrap-checkbox.css">
    <link rel="stylesheet" href="${basePath}/js/resources/assets/css/vendor/bootstrap/bootstrap-dropdown-multilevel.css">

    <link href="${basePath}/js/resources/assets/css/minimal.css" rel="stylesheet">

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      <script src="${basePath}/js/common/html5shiv.js"></script>
      <script src="${basePath}/js/resources/respond.min.js"></script>
    <![endif]-->
  </head>
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12 full-page login">
          ...
          <div class="inside-block">
            <img src="${basePath}/js/resources/assets/images/logo-big.png" alt="" class="logo">
            ...
            <form id="_form" action="" method="post" class="form-signin">
              ...
              <button class="btn btn-greensea" id="login">登录</button>
                <span>or</span>
                <button class="btn btn-slategray" id="register">创建账号</button>
              </section>
            </form>
          </div>
